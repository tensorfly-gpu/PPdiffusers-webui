...
def diffusers_auto_update():
    try:
        ...
        if not (safetensors.__version__ == "0.2.8"
                and paddlenlp.__version__ == "2.5.2"
                and ppdiffusers.__version__ == "0.14.0"):
            raise ImportError
        print("environment all ready!")

    except (ModuleNotFoundError, ImportError, AttributeError):
        print('检测到库不完整或版本不正确, 正在安装库')
        # os.system("pip install -U gradio --user -i https://mirror.baidu.com/pypi/simple") # aistudio上已配置gradio
        ...
        os.system("pip install ppdiffusers==0.14.0 --user -i https://mirror.baidu.com/pypi/simple")
        os.system("pip install paddlenlp==2.5.2 --user -i https://mirror.baidu.com/pypi/simple")
